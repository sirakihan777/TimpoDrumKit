...
namespace TimpoDrumKit
{
	...
	constexpr SprTypeDesc SprDescTable[] =
	{
		...
		{ SprID::Timeline_Note_DonHand,				SprGroup::Timeline, u8"assets/graphics/timeline_note_don_hand.svg" },
		...
		{ SprID::Timeline_Note_KaHand,				SprGroup::Timeline, u8"assets/graphics/timeline_note_ka_hand.svg" },
		{ SprID::Timeline_Note_KaDon,				SprGroup::Timeline, u8"assets/graphics/timeline_note_kadon.svg" },
		...
		{ SprID::Timeline_Note_Bomb,				SprGroup::Timeline, u8"assets/graphics/timeline_note_bomb.svg" },
		...
		{ SprID::Game_Note_DonHand,					SprGroup::Game, u8"assets/graphics/game_note_don_hand.svg" },
		...
		{ SprID::Game_Note_KaHand,					SprGroup::Game, u8"assets/graphics/game_note_ka_hand.svg" },
		{ SprID::Game_Note_KaDon,					SprGroup::Game, u8"assets/graphics/game_note_kadon.svg" },
		...
		{ SprID::Game_Note_Bomb,					SprGroup::Game, u8"assets/graphics/game_note_bomb.svg" },
		{ SprID::Game_Note_Adlib,					SprGroup::Game, u8"assets/graphics/game_note_adlib.svg" },
		{ SprID::Game_Note_Fuse,					SprGroup::Game, u8"assets/graphics/game_note_fuse.svg" },
		{ SprID::Game_Note_FuseLong,				SprGroup::Game, u8"assets/graphics/game_note_fuse_long.svg" },
		{ SprID::Game_Note_ArmDown,					SprGroup::Game, u8"assets/graphics/game_note_arm_down.svg" }, // workaround for size bug (?), need to update ThorVG
		{ SprID::Game_NoteTxt_Do,					SprGroup::Game, u8"assets/graphics/game_note_txt_do.svg" },
		{ SprID::Game_NoteTxt_Ko,					SprGroup::Game, u8"assets/graphics/game_note_txt_ko.svg" },
		...
		{ SprID::Game_NoteTxt_DonHand,				SprGroup::Game, u8"assets/graphics/game_note_txt_don_hand.svg" },
		...
		{ SprID::Game_NoteTxt_KatsuHand,			SprGroup::Game, u8"assets/graphics/game_note_txt_katsu_hand.svg" },
